...
const CONFIG = {
  ...
  /* Shared intake inbox — point at a dedicated Heartland address when one exists. */
...
/* Namespaced so a draft here never collides with the Midwest Biolabs desk
   when both sites are served from the same origin. */
const DRAFT_KEY = 'heartland.quote.draft.v1';
